app="undefined"!=typeof app?app:{},function(){"use strict";function i(i,t,s,a,n){a[i]=n,t&&s(a)}this.api=this.api||{backend:server,cache:{},cacheExpiration:18e4},this.api.saveToCache=function(i,t,s){this.api.cache[i]={modified:(new Date).getTime(),response:s},t(s)}.bind(this),this.api.ajax=function(i,t,s,a){var n=i+"-"+t;if(this.log("api "+n,this.logType.debug),"get"===i){var p=this.api.cache;a=s,"get"===i&&p[n]&&p[n].modified>(new Date).getTime()-this.api.cacheExpiration?a(p[n].response):O.AJAX.get(this.api.backend+t,this.api.ifNotError.bind(this,this.api.saveToCache.bind(this,n,a)))}else this.api.clearCache(),"post"===i||"put"===i?O.AJAX[i](this.api.backend+t,s,this.api.ifNotError.bind(this,a)):(a=s,O.AJAX[i](this.api.backend+t,this.api.ifNotError.bind(this,this.api.saveToCache.bind(this,n,a))))}.bind(this),this.api.clearCache=function(){this.api.cache={}}.bind(this),this.api.ifNotError=function(i,t){t instanceof Error&&t.message instanceof XMLHttpRequestProgressEvent&0===t.status?O.EVT.dispatch("connection-error",t.message):i(t)}.bind(this),this.api.async=function(t,s){for(var a=t.slice().reverse(),n={};a.length;){var p=a.pop(),o=p.name.split(" ").pop();p(i.bind(this,o,0===a.length,s,n))}}.bind(this),this.api.ping=function(i){O.AJAX.get(this.api.backend+"ping",this.api.ifNotError.bind(this,i))}.bind(this);var t=function(i,t,s,a){this.api.ajax("post",i,{email:t,password:s},a)};return this.api.signIn=t.bind(this,"signin"),this.api.signUp=t.bind(this,"signup"),this.api.getEmail=function(i){this.api.ajax("get","email/",i)}.bind(this),this.api.addCommunity=function(i,t){this.api.ajax("post","community/",i,t)}.bind(this),this.api.getCommunityList=function(i){this.api.ajax("get","community/",i)}.bind(this),this.api.getMyCommunities=function(i){this.api.ajax("get","membership/",i)}.bind(this),this.api.getCommunity=function(i,t){this.api.ajax("get","community/"+i+"/",t)}.bind(this),this.api.getCommunityTopics=function(i,t){this.api.ajax("get","community/"+i+"/topics/",t)}.bind(this),this.api.joinCommunity=function(i,t,s){this.api.ajax("post","community/"+i+"/members/",t,s)}.bind(this),this.api.quitCommunity=function(i,t){this.api.ajax("post","community/"+i+"/quit/",{},t)}.bind(this),this.api.archive=function(i,t,s){this.api.ajax("delete",i+"/"+t,s)}.bind(this),this.api.getCommunityTopics=function(i,t){this.api.ajax("get","community/"+i+"/topics/",t)}.bind(this),this.api.addTopic=function(i,t){this.api.ajax("post","topic/",i,t)}.bind(this),this.api.getTopicOpinions=function(i,t){this.api.ajax("get","topic/"+i+"/opinions/",t)}.bind(this),this.api.setOpinion=function(i,t){i.id?this.api.ajax("post","opinion/"+i.id,i,t):i.topicId?this.api.ajax("post","topic/"+i.topicId+"/opinion/",i,t):t(new Error("missing-details"))}.bind(this),this.api.getPostComments=function(i,t,s){var a=void 0===t?"opinion":"comment";"opinion"===a&&(t=i),this.api.ajax("get",a+"/"+t+"/comments/",s)}.bind(this),this.api.setComment=function(i,t){i.id?this.api.ajax("post","comment/"+i.id,i,t):this.api.ajax("post","comment/",i,t)}.bind(this),this.api.feedback=function(i,t){this.api.ajax("post","feedback/",i,t)}.bind(this),this}.call(app);
...
app="undefined"!=typeof app?app:{},function(){"use strict";function t(t){for(var i="",e=0,n={},m=t.length;m--;){var s=t[m].membershipName,o=n[s];o=void 0===n[s]?1:o+1,n[s]=o,o>=e&&(i=s,e=o)}O.ELM.founderName.value=i}function i(t,i){this.state.communityJSON=i.getCommunity,this.state.communityTopics=i.getCommunityTopics,this.state.email=i.getEmail.email;var e={communityId:i.getCommunity.id,communityName:i.getCommunity.name,isMember:void 0!==i.getCommunity.membership&&"active"===i.getCommunity.membership.status,topics:i.getCommunityTopics};e.isMember&&(e.memberName=i.getCommunity.membership.name?i.getCommunity.membership.name:""),e.username=i.getEmail.email,console.log(this.state),console.log(e),this.render(O.ELM.pageContainer,{communityPage:e}),t()}function e(t){var i={name:O.ELM.communityName.value};if(0===i.name.length)alert("name cannot be empty");else{var e=O.ELM.founderName.value;e.length>0&&(i.founderName=e),this.api.addCommunity(i,n.bind(this))}t.detail.preventDefault()}function n(t){t instanceof Error||!t?(alert("failed to add community"),console.log(t)):location.href="#community:"+t.id}function m(t,i){this.render(t,{communityList:{communities:{community:i}}})}function s(t,i){var e={isAuthenticated:this.isAuthenticated(),communityId:i.id,communityName:i.name,isMember:i.membership&&"active"===i.membership.status?!0:!1};this.render(O.ELM.pageContainer,{communityJoinPage:e}),t()}function o(t){var i=this.state.community,e={name:O.ELM.memberName.value};this.api.joinCommunity(i,e,a.bind(this,i)),t.detail.preventDefault()}function a(t,i){i instanceof Error?409===i.status?this.updateURL("community:"+t+"/",O.TPL.translate("pageTitle.community")):(this.log(i,this.logType.debug),alert("failed to join community")):this.updateURL("community:"+t+"/",O.TPL.translate("pageTitle.community"))}function u(t){this.confirm(O.TPL.translate("confirm.leaveCommunity"),r.bind(this)),t.detail.preventDefault()}function r(t){t&&this.api.quitCommunity(this.state.community,c.bind(this))}function c(){this.updateURL("community/",O.TPL.translate("pageTitle.community"))}return this.registry=this.registry||{},O.EVT.subscribe("submit-add-community",e.bind(this)).subscribe("request-quit-community",u.bind(this)),this.registry.frmAddCommunity=function(i,e){i.onsubmit=O.EVT.getDispatcher("submit-add-community"),this.api.getMyCommunities(t.bind(this)),e()}.bind(this),this.registry.communityPage=function(t,e){var n=this.state.community;void 0!==n&&n.length>0?this.api.async([this.api.getEmail.bind(this),this.api.getCommunity.bind(this,n),this.api.getCommunityTopics.bind(this,n)],i.bind(this,e)):this.updateURL("communities","")}.bind(this),this.registry.myCommunityList=function(t,i){this.api.getCommunityList(m.bind(this,t)),i()}.bind(this),this.registry.communityJoinPage=function(t,i){var e=this.state.community;this.api.getCommunity(e,s.bind(this,i))}.bind(this),this.registry.frmJoinCommunity=function(t,i){t.onsubmit=O.EVT.subscribe("submit-join-community",o.bind(this)).getDispatcher("submit-join-community"),i()}.bind(this),this.registry.btnLeave=function(t,i){t.onclick=O.EVT.getDispatcher("request-quit-community"),i()}.bind(this),this}.call(app);
app="undefined"!=typeof app?app:{},function(){"use strict";var n=0;this.registry=this.registry||{},this.state=this.state||{},this.registry.ping=function(n,i){n.onclick=O.EVT.subscribe("ping",this.api.ping.bind(this,pong)).getDispatcher("ping"),i()}.bind(this);var i=function(){var n=O.COOKIE("authToken"),i=n.length>0;i&&O.AJAX.setDefaults({credentials:n}),this.render(O.ELM.appContainer,{application:{showUserDetailsInHeader:i}}),this.register(O.ELM.appContainer)}.bind(this);return this.onConnectionError=function(){void 0===O.ELM.connectionError&&this.notify({notifyErrorConnection:{}})}.bind(this),this.onComponentLoaded=function(){--n||(window.onhashchange=O.EVT.subscribe("window.onhashchange",this.onPageChanged).getDispatcher("window.onhashchange"),O.ELM.refresh(),i(),this.ping())}.bind(this),this.init=function(){n=3,O.EVT.subscribe("window.onload",this.onComponentLoaded).subscribe("TPL.templatesLoaded",this.onComponentLoaded).subscribe("TPL.languageLoaded",this.onComponentLoaded).subscribe("connection-error",this.onConnectionError),O.TPL.load("templates.html"),O.TPL.setLocale("en-us"),O.TPL.loadLanguage("i18n/en-us.json")}.bind(this),this.init(),this}.call(app);
app="undefined"!=typeof app?app:{},function(){"use strict";function t(){return this.log("not yet implemented",this.logType.error),!1}function i(t){var i=t.detail.target.closest("[data-id][data-type]"),e=i.getAttribute("data-type"),n=i.getAttribute("data-id"),s=i.parentNode;this.api.archive(e,n,this.simplyReturn),this.updateCount(s.closest("[data-id][data-type]"),i.getAttribute("data-type"),-1),"oion"!==e?O.DOM.remove(s):O.ELM.opinionContent.value=""}function e(t,i){void 0!==O.ELM.connectionError&&O.DOM.remove(O.ELM.connectionError),this.state.username=i.username,t&&t()}return this.registry=this.registry||{},this.state=this.state||{},this.registry.appContainer=function(t,i){this.renderPage(),i()}.bind(this),this.onCancelButtonClicked=function(){history.back()}.bind(this),this.registry.btnCancel=function(t,i){t.onclick=this.onCancelButtonClicked,i()}.bind(this),O.EVT.subscribe("submit-page-not-found",t.bind(this)),this.registry.notFoundPage=function(t,i){O.ELM.frmPageNotFound.onsubmit=O.EVT.getDispatcher("submit-page-not-found"),O.ELM.pageNotFoundURL.value=window.location.hash}.bind(this),this.isAuthenticated=function(){var t=O.COOKIE("authToken");return t.length>0}.bind(this),this.onPageChanged=function(t){var i=t.detail.newURL;this.renderPage(i.substr(i.indexOf("#")),"")}.bind(this),this.updateURL=function(t,i){history.pushState({},i,location.href.split("#")[0]+"#"+t),this.renderPage()}.bind(this),this.getPageTitleFromHash=function(t){if(!t.length)return"";for(var i=t[0].key,e=1;e<t.length;e++){var n=t[e].key;i+=" "+n.substr(0,1).toUpperCase()+n.substr(1)}return i}.bind(this),this.setAppTitle=function(t){var i=document.title.split(":")[0];document.title=i+(t.length>0?": "+t.substr(0,1).toUpperCase()+t.substr(1):"")}.bind(this),this.renderPage=function(){var t={},i=this.extractArgumentsFromLocationHash(),e=this.getPageTitleFromHash(i),n=(e.length?e.replace(/\s/g,""):this.isAuthenticated()?"home":"welcome")+"Page";O.ELM.appContainer.setAttribute("data-section",i.length>0?i[0].key:"home"),-1===O.TPL.list().indexOf(n)&&(n="notFoundPage"),t[n]={isAuthenticated:this.isAuthenticated()},this.state=this.extend(this.state,this.getMappedArguments()),this.setAppTitle(e),this.log("renderPage "+n,this.logType.debug),this.render(O.ELM.pageContainer,t),this.register(n)}.bind(this),O.EVT.subscribe("archive",i.bind(this)),this.registry.archive=function(t,i){t.onclick=O.EVT.getDispatcher("archive"),i()}.bind(this),this.updateCount=function(t,i,e){if(t){var n=t.querySelector('[data-role="'+i+'-count"]');n&&(n.innerHTML=+n.innerHTML+e)}}.bind(this),this.ping=function(t){this.api.ping(e.bind(this,t))}.bind(this),this.onCloseNotificationClicked=function(t){return O.DOM.remove(t.target.closest(".notification")),!1}.bind(this),this.registry.closeNotification=function(t,i){t.onclick=this.onCloseNotificationClicked,i()}.bind(this),this}.call(app);
