/** @module theodorus.models.AbdstractModel */
(function AbdstractModelClosure () {
    var _ = (_ || require("underscore")),
        Backbone = (Backbone || require("backbone")),
        /** @class AbdstractModel */
                        ...
                        if (!hasValue && schema[key].defaultValue) {
                            ...
                            switch (schema[key].type) {
                                ...
                                case "boolean" :
                                    ...
                                    break;
                                case "array" :
                                    value = hasValue ? (typeof newValue == "object" ? newValue : JSON.parse(newValue) ) : [];
                                    break;
                                case "object" :
                                    value = hasValue ? (typeof newValue == "object" ? newValue : JSON.parse(newValue)) : {};
                                    break;
