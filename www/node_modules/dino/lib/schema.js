...
var methods = {
    ...
    generateQueryParams: function (attrs) {
        ...
        _.each(attrs, function(val, attr){
            ...
            if (self.hashKeyAttributes && self.hashKeyAttributes.indexOf(attr) >= 0)
            {
                hashAttrCount++;
            ...
            if (self.rangeKeyAttributes && self.rangeKeyAttributes.indexOf(attr) >= 0)
            {
                rangeAttrCount++;
            ...
            if (self.secondaryKeyAttributes && self.secondaryKeyAttributes.indexOf(attr) >= 0)
            {
