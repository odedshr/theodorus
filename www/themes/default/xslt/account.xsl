...
<xsl:stylesheet id="sheet" version="1.0"
    ...
    <xsl:template match="user">
        <xsl:choose>
            ...
            <xsl:otherwise>
                <a id="btn_signup" class="button" href="/signup" target="_blank"><xsl:value-of select="$btn_signup" /></a>
                <a id="btn_signin" class="button" href="/signin" target="_blank"><xsl:value-of select="$btn_signin" /></a>
