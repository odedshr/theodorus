module.exports = function(grunt) {
    ...
    switch (option) {
        ...
        case "client":
            ...
            npms = ['grunt-contrib-uglify',
                'grunt-contrib-jshint',
                'grunt-copy-to',
                'grunt-recess'
            ];
            tasks = ['jshint','copyto','recess','uglify'];
            break;
        default:
            config = {
                pkg: grunt.file.readJSON('package.json'),
                ...
                copyto: {
                    copy_files_to_build: {
                        files: [
                            { cwd: '.', src: ['package.json','LICENSE','README.md'], dest: 'build/'},
                            { cwd: 'node_modules', src: ['cheerio/**', 'backbone/**', 'cookie-parser/**', 'express/**', 'formidable/**', 'imagemagick/**', 'mysql/**', 'nodemailer/**', 'orm/**', 'underscore/**'], dest: 'build/node_modules/'},
