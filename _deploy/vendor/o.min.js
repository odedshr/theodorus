〇=O=(function(){
                ...
                xmlhttp.onload = function () {
                    if (xmlhttp.readyState == XMLHttpRequest.DONE) {
                        if (+xmlhttp.readyState == 4 && +xmlhttp.status == 200) {
                            ...
                            var error = new DetailedError(xmlhttp.statusText, {});
    ...
    this.TPL = (function TPL() {
        ...
        var use = (function use (dElm) {
            var id = dElm ? dElm.getAttribute('data-template') : false;
            if (id) {
                templates[id] = dElm;
            } else {
        ...
        var load = (function load (sUrl) {
            this.AJAX.get(sUrl, (function (response) {
                var loadedTemplates = response.querySelectorAll('[data-template]:not([data-template=""]');
        ...
        var populate = function (string, data) {
            ...
            while (item = loopPattern.exec(string)) {
                ...
                if (loopableElement !== undefined) {//} && loopableElement.forEach) {
                    loopableElement.forEach(function perValue(value, index) {
